...
if(isset($_POST['email']) && isset($_POST['phone'])) {
	$body = "Сайт: ".$_POST['site'] . "<br>" . 
			"Контактное лицо: ".$_POST['contact'] . "<br>" . 
			"Страна: ".$_POST['country'] . "<br>" . 
			"Телефон: ".$_POST['phone'] . "<br>" . 
			"Email: ".$_POST['email'] . "<br>" . 
			"Терминал: ".$_POST['terminal'] . "<br>" . 
			"Дата/Время: ". date("H:i:s d M Y") . "<br>";
			
	$headers  = 'MIME-Version: 1.0' . "\r\n";
	$headers .= 'Content-type: text/html; charset=utf-8' . "\r\n";
	@mail("vmeste@yamoney.ru, rananev@yamoney.ru", "Новая заявка Касса для благотворительности", $body, $headers);
	$sent = true;
}
?>
<!doctype html>
...
<div class="app">
  <header>
    <div class="content">
      <a class="logo" href="https://money.yandex.ru/"><img src="img/logo.png"></a>
    ...
    <div class="front" id="payment_options_section">
      ...
      <div class="items">
        ...
        <div class="item"><i class="sms"></i>
          <p>SMS</p><span>C номеров Билайн, МегаФон, МТС, Tele2 <br>и Ростелеком.</span></div>
  ...
  <div class="start">
    ...
    <div class="front" id="start_section">
      <h2>Быстрый старт</h2>
      <p class="slogan">Не нужно ничего настраивать &mdash; мы обо всем позаботимся.</p>
      ...
      <div class="items">
        ...
        <div class="item i2">
          <i></i>
          <p>Мы соберем страницу<br> за несколько дней</p>
        </div>
        <div class="item i3">
          <i></i>
        ...
        <form autocomplete="off" id="form" method="POST" onsubmit="yaCounter152220.reachGoal('CHARITY_FORM_SUBMIT'); return true;"  enctype="application/x-www-form-urlencoded" action="<?php echo $_SERVER['PHP_SELF']; ?>#kassa_section">
          ...
          <div class="row">
            <div class="item">
              ...
              <?php } ?>
                  <p class="success_submit">Приятно познакомиться! Мы перезвоним вам<br> в течение двух дней, чтобы вы успели подготовить текст и картинки для вашей страницы.</p>
