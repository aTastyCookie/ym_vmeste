 ...
 * @author chedim
 */
abstract class ZenCurlAbstract {
...
//            curl_setopt($ch, CURLOPT_POSTFIELDSIZE, strlen($data));
		...
		if(!defined('PATH_TO_CERT')) { 
			define('PATH_TO_CERT', getcwd() . '/library/ymoney.pem');  
		}
		curl_setopt($ch, CURLOPT_CAINFO, PATH_TO_CERT);
    ...
    public static function debugLast() {
        echo '<hr/>';
        echo '<center><h1>ZenCurl debug</h1></center>';
        echo '<hr/>';
