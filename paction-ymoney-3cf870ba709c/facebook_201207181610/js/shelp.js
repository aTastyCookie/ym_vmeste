...
//                            console.log(info);
                        ...
                        $(this).fb_popup({
                            ...
                            overflow: 'visible',
                            custom_btn: {
                                ok : '<a href="#" class="p_btn" onclick="sentMessages(); return false;" style="color: #fff; background: none repeat scroll 0 0 #6D84B4;">Отправить на стену</a>',
                                cansel : '<a href="#" class="p_btn" onclick="popupClose(); return false;">Отмена</a>'
                            },
                            notshowok: true
                        });
...
//                            }
                            ...
                            $('.p_pad .pop1').append("<textarea rows='4' id='friendsmessage' style='width:350px; height:42px; float:right; resize: none;'>Друзья, поддержите хорошее дело!</textarea>");
                            $('.p_pad').append('<div class="pop2" style="padding: 7px 0px 0px 3px; display: inline-block;"><a href="#" style="margin-left:62px; text-decoration: none;">Добавить друзей</a></div>');
                        });
...
//                                console.log(info);
                            ...
                            $(this).fb_popup({
                                ...
                                overflow: 'visible',
                                custom_btn: {
                                    ok : '<a href="#" class="p_btn" onclick="sentMessages(); return false;" style="background: none repeat scroll 0 0 #6D84B4; color: #fff;">Отправить на стену</a>',
                                    cansel : '<a href="#" class="p_btn" onclick="popupClose(); return false;">Отмена</a>'
                                },
                                notshowok: true
                            });
...
//                                }
                                $('.p_pad .pop1').append('<img src="' + info + '" width="50" height="50" alt="User photo" />');
                                $('.p_pad .pop1').append("<textarea rows='4' id='friendsmessage' style='width:350px; height:42px; float:right'>Друзья, поддержите хорошее дело!</textarea>");
                                $('.p_pad').append('<div class="pop2" style="padding: 7px 0px 0px 3px; display: inline-block;"><a href="#" style="margin-left:62px; text-decoration: none;">Добавить друзей</a></div>');
                            });
