...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
	...
	public function _initConfig()
	{
      ...
      $config->ymoney->APP_PAGE = $config->ymoney->APP_PAGE.'?x='.substr(time(), 3);
  ...
  public function _initPlugin() {
    ...
    $frontController->registerPlugin(new Ymoney_Controller_Plugin_VkSession());
    
    $frontController->registerPlugin(new Ymoney_Controller_Plugin_UriHash());
  }
